...
project_path = "/state/partition/whcui/repository/project/Abacus/"
abacus_src_path = project_path + "data/server/7.6_cluster/Abacus"
abacus_raw_file = project_path + "data/server/7.6_cluster/Abacus_raw.csv"
abacus_clean_file = project_path + "data/server/7.6_cluster/Abacus_clean.csv"

clock_src_path = project_path + "data/server/7.6_cluster/Clock"
clock_raw_file = project_path + "data/server/7.6_cluster/Clock_raw.csv"
clock_clean_file = project_path + "data/server/7.6_cluster/Clock_clean.csv"
