...
python main.py --task server --model_num 4 --comb 1 2 5 6 --policy SJF --load 100 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1

python main.py --task server --model_num 4 --comb 1 2 5 6 --policy FCFS --load 100 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1

python main.py --task server --model_num 4 --comb 1 2 5 6 --policy EDF --load 100 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1

python main.py --task server --model_num 4 --comb 1 2 5 6 --policy Abacus --load 100 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1
