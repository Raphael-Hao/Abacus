...
python main.py --task serve --model_num 4 --comb 1 2 5 6 --policy SJF --load 50 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1

python main.py --task serve --model_num 4 --comb 1 2 5 6 --policy FCFS --load 50 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1

python main.py --task serve --model_num 4 --comb 1 2 5 6 --policy EDF --load 50 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1

python main.py --task serve --model_num 4 --comb 1 2 5 6 --policy Abacus --load 50 --qos ${qos_target} --queries 1000 --thld 5 --ways 2 --abandon --mig 1
